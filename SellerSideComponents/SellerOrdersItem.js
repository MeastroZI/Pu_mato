...
export default function SellerOrdersItem({ itemInfo, cancleOrder }) {
    const Quantity = 2 ;
    ...
    return (
        <View style={styles.itemsContainer}>
            ...
            <View style={styles.InfoContainer}>
                ...
                <View style={{width : '100%' , alignItems : 'center' , justifyContent :'flex-start'  , flexDirection : 'row' , padding : 10} }>
